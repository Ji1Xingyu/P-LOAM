...
typedef pcl::PointXYZRGB PointRviz2show;

extern const string pointCloudTopic = "/os_cloud_node/points";
extern const string imuTopic = "/imunah";
...
struct Params{
    double segHeightThd;
    // delete both or?????????
    double segSpacingThd;
    double segDirThd, segRtThd;
    double segmentTheta = 55.0/180.0*M_PI; // decrese this value may improve accuracy
